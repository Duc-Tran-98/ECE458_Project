...
function CreateModelPage({ onCreation }) {
  ...
  const handleSubmit = (values, formReset) => {
    ...
    const {
      modelNumber, vendor, description, comment, categories, calibratorCategories, supportLoadBankCalibration, supportKlufeCalibration, supportCustomCalibration, requiresCalibrationApproval, customForm,
    } = values;
    CreateModel({
      modelNumber,
      vendor,
